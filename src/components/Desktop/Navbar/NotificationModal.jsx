            ...
            <div className="divide-y divide-gray-100">
              {localNotifications.map((notification) => (
                <div
                  ...
                  className={`p-4 hover:bg-gray-50 transition-colors cursor-pointer ${notification.read_at === null ? 'bg-blue-50' : ''
                    }`}
                >
                  <div className="flex items-start space-x-3">
                    {/* Icon */}
                    <div className={`flex-shrink-0 w-10 h-10 rounded-full flex items-center justify-center ${notification.read_at === null ? 'bg-white' : 'bg-gray-100'
                      }`}>
                    ...
                    <div className="flex-1 min-w-0">
                      <p className={`text-sm ${notification.read_at === null
