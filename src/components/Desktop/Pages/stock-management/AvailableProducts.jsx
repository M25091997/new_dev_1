    ...
    <div className="p-4 space-y-4">
      ...
      <div className="flex items-center justify-between mb-2">
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h1 className="text-xl font-bold text-gray-900 mt-5">Available Products</h1>
            <p className="text-sm text-gray-500 mt-1 mb-3">Products currently in stock</p>
          </div>
        </div>
        <div className="bg-green-100 px-4 py-2 rounded-lg mt-5">
          <p className="text-xs text-green-600 font-medium">Available Products</p>
          ...
          <table className="w-full">
            ...
            <tbody className="bg-white divide-y divide-gray-100">
              {paginatedData.map((variant) => (
                <tr key={variant.product_variant_id} className="hover:bg-green-50 transition-colors">
