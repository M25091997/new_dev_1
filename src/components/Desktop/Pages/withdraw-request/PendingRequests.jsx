...
const PendingRequests = () => {
  ...
  const pendingRequests = withdrawalData.withdraw_requests?.filter(req => req.status === 0) || [];
  ...
  return (
    <div className="p-4 space-y-4">
      ...
      <div className="flex items-center space-x-4 mb-4">
        ...
        <div>
          <h1 className="text-xl font-bold text-gray-900 mt-5">Pending Withdrawal Requests</h1>
      ...
      <div className="bg-gradient-to-br from-orange-500 to-orange-600 rounded-lg p-6 text-white shadow-lg">
        <div className="flex items-center justify-between">
          <div>
            <p className="text-orange-100 text-sm mb-2">Total Pending Amount</p>
            <h2 className="text-3xl font-bold">{formatCurrency(totalPendingAmount)}</h2>
            <p className="text-orange-100 text-sm mt-2">{pendingRequests.length} requests pending</p>
          </div>
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-4">
        <div className="flex items-center gap-2">
          ...
          <div className="text-right">
            ...
            <p className="text-lg font-bold text-orange-600">{filteredData.length}</p>
          </div>
        </div>
      </div>
              ...
              {paginatedData.map((request) => (
                <tr key={request.id} className="hover:bg-orange-50 transition-colors">
                  <td className="px-4 py-3 whitespace-nowrap">
                    <span className="inline-flex items-center px-2 py-1 rounded-md bg-orange-100 text-orange-700 text-xs font-semibold">
                      #{request.id}
                    </span>
                  </td>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="px-2 py-1 border border-gray-300 rounded-md text-xs focus:ring-2 focus:ring-orange-500 focus:border-orange-500"
              >
