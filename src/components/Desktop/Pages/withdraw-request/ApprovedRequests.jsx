  ...
  return (
    <div className="p-4 space-y-4">
      ...
      <div className="flex items-center space-x-4 mb-4">
        ...
        <div>
          <h1 className="text-xl font-bold text-gray-900 mt-5">Approved Withdrawal Requests</h1>
          <p className="text-sm text-gray-500 mt-1">Successfully processed withdrawals</p>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-lg p-6 text-white shadow-lg">
        <div className="flex items-center justify-between">
          <div>
            <p className="text-green-100 text-sm mb-2">Total Approved Amount</p>
            <h2 className="text-3xl font-bold">{formatCurrency(totalApprovedAmount)}</h2>
            <p className="text-green-100 text-sm mt-2">{approvedRequests.length} requests approved</p>
          </div>
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-4">
        <div className="flex items-center gap-2">
          ...
          <div className="text-right">
            ...
            <p className="text-lg font-bold text-green-600">{filteredData.length}</p>
          </div>
        </div>
      </div>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="px-2 py-1 border border-gray-300 rounded-md text-xs focus:ring-2 focus:ring-green-500 focus:border-green-500"
              >
