  ...
  return (
    <div className="p-4 space-y-4">
      ...
      <div className="flex items-center space-x-3 mb-4">
        ...
        <div>
          <h1 className="text-xl font-bold text-gray-900">This Month Transactions</h1>
          <p className="text-sm text-gray-500">Transactions for {new Date().toLocaleDateString('en-GB', { month: 'long', year: 'numeric' })}</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg p-6 border border-gray-200 shadow-sm">
        <div className="flex items-center justify-between">
          <div>
            <p className="text-sm font-medium text-gray-500 uppercase mb-2">This Month Earnings</p>
            <h2 className="text-4xl font-bold text-blue-600">{formatCurrency(summary.thisMonthEarnings)}</h2>
          </div>
        ...
        <div className="grid grid-cols-3 gap-4 mt-6 pt-6 border-t border-gray-200">
          ...
          <div>
            <p className="text-xs text-gray-500 mb-1">This Month Transactions</p>
            <p className="text-lg font-semibold text-gray-900">{thisMonthTransactions.length}</p>
          </div>
          <div>
      ...
      <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
        <div className="px-4 py-3 border-b border-gray-200 bg-gray-50">
          <div className="flex items-center justify-between">
            <h3 className="text-sm font-semibold text-gray-900">This Month Transactions</h3>
