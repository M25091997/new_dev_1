    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-200 px-3 py-2.5 sticky top-0 z-10">
        <div className="flex items-center space-x-2">
          ...
          <div>
            <h1 className="text-base font-semibold text-gray-900">Pending Requests</h1>
            <p className="text-xs text-gray-500">{pendingRequests.length} requests</p>
          </div>
        </div>
      </div>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2.5">
              ...
              <div>
                ...
                <h2 className="text-xl font-bold text-gray-900">{formatCurrency(totalPendingAmount)}</h2>
              </div>
            </div>
        ...
        <div className="bg-white rounded-lg p-2.5 shadow-sm border border-gray-100">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-9 pr-3 py-2 text-sm border border-gray-200 rounded-lg focus:ring-1 focus:ring-orange-500 focus:border-orange-500"
            />
          </div>
          {searchTerm && (
